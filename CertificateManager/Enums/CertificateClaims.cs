...
namespace FrdCoreCrypt.Enums
{
    public class CertificateClaims
    {
        ...
        public const string SubjectEmail = "cert_subj_EMAIL";
        public const string SubjectUserid = "cert_subj_USERID";
        public const string SubjectLoyality = "cert_subj_LOYALITY";
        public const string SubjectInitials = "cert_subj_INITIALS";
        public const string SubjectPostalCode = "cert_subj_POSTCODE";
